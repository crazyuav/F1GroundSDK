...
#define SRAM_UART_DATA_ST_ADDR          (SRAM_MAVLINK_RC_MSG_ST_ADDR + SRAM_MAVLINK_RC_MSG_SIZE)
#define SRAM_UART_DATA_SIZE             (0x400) 
#define SRAM_UART_DATA_END_ADDR         (SRAM_UART_DATA_ST_ADDR + SRAM_UART_DATA_SIZE - 1)
