...
#define  GROUND_LED_GPIO_GREEN			(68)
#define  GROUND_LED_GPIO_RED			(60)
#define  GROUND_LED_GPIO_BLUE			(28)
#define  GROUND_LED_GPIO_YELLOW			(72)
#define  GROUND_LED_GPIO_WHITE			(29)
#define  GROUND_LED_GPIO_BROWN			(64)

#define  CORE_LED_GPIO_GREEN			(10)
#define  CORE_LED_GPIO_RED				(11)
#define  CORE_LED_GPIO_BLUE				(12)
#define  CORE_LED_GPIO_YELLOW			(13)
#define  CORE_LED_GPIO_WHITE			(14)
#define  CORE_LED_GPIO_BROWN			(15)
...
HAL_RET_T HAL_LED_ON(ENUM_HAL_GPIO_NUM e_gpioPin);

HAL_RET_T HAL_LED_OFF(ENUM_HAL_GPIO_NUM e_gpioPin);

HAL_RET_T HAL_LED_TOGGLE(ENUM_HAL_GPIO_NUM e_gpioPin);
